<?php
	...
	elseif ($loginType == 'student') {	
			...
			$data = "SELECT * FROM student_info WHERE email = '$name' and password = '$pass'";
	...
	elseif ($loginType == 'teacher') {	
			...
			$data = "SELECT * FROM teacher_info WHERE email = '$name' and password = '$pass'";
			$result = mysqli_query($connectivity, $data);
